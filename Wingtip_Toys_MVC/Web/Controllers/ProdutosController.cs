...
namespace Web.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProdutoID,Nome,Descricao,Ativo,CategoriaID")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProdutoID,Nome,Descricao,Ativo,CategoriaID")] Produto produto)
        {
            if (ModelState.IsValid)
            {
